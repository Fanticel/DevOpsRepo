...
public class TeamControllerTest {
    ...
    public void getTeamMemberTest() throws Exception {
        TeamMember mockMember = new TeamMember("Member1", "Chase", "chase@pawpatrol.org", new ArrayList<>());
        Mockito.when(teamService.getTeamMember(Mockito.anyString())).thenReturn(mockMember);
    }
}
